...
## Current extensions and future onboarding work

Owner-authorised business creation, resumable onboarding, public-route slugs, team invitations, Business Knowledge review, feature entitlements and audit/lifecycle foundations now exist in source. Remaining expansion should focus on multi-location resources, industry-template versioning, optional deeper onboarding into Knowledge uploads/add-ons, and clearer operational support setup. None should rely on editable Auth metadata.
