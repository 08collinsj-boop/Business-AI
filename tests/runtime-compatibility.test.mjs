...
const apiModules = ["leads.js", "history.js", "pipeline.js", "settings.js", "business-configuration.js", "business-onboarding.js", "bookings.js", "actions.js", "operations.js", "enquiry.js", "voice.js", "stripe-webhook.js"];
const libraryModules = ["auth.js", "audit.js", "business-configuration.js", "operational-log.js", "public-rate-limit.js", "public-tenant.js", "public-business-handler.js", "public-config-handler.js", "voice.js", "voice-simulation.js", "voice-status-handler.js", "audit-log-handler.js", "data-lifecycle-handler.js", "data-subjects-handler.js", "health-handler.js", "voice-webhook-handler.js", "voice-calls-handler.js", "team-handler.js", "handover-handler.js", "billing.js", "stripe.js", "billing-handler.js", "stripe-webhook-handler.js", "stripe-webhook-fetch-handler.js"];
...
test("all Vercel API modules load directly as ESM", async () => {
  ...
  for (const moduleName of apiModules) {
    ...
    if (moduleName === "stripe-webhook.js") assert.equal(typeof module.default?.fetch, "function", `${moduleName} must export a Web Standard fetch handler`);
    else assert.equal(typeof module.default, "function", `${moduleName} must export a handler`);
  }
