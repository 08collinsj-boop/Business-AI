...
const apiModules = ["_auth.js", "_voice.js", "leads.js", "history.js", "pipeline.js", "settings.js", "bookings.js", "actions.js", "public-config.js", "enquiry.js", "voice-webhook.js", "voice-calls.js"];
...
test("all Vercel API modules load directly as ESM", async () => {
  ...
  for (const moduleName of apiModules) {
    ...
    if (!["_auth.js", "_voice.js"].includes(moduleName)) assert.equal(typeof module.default, "function", `${moduleName} must export a handler`);
  }
});
